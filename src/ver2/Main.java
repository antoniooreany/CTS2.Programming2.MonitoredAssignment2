...
//        Node n = controller.barChart.lookup(".data0.chart-bar");
//        n.setStyle("-fx-bar-fill: #fd84ff;");

        // Handle a mouse press and drag event on the scene.
//        paintPane.addEventHandler(MouseEvent.ANY, paintPane.getMouseEventHandler()); //TODO Move this statement into the constructor of the PaintPane?
        // Create a scene.
